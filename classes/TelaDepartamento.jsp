...
<body>
	<div class="window" id="janela1" rel="modal">
		...
		<table>
			<caption
				style="font-size: 200%; padding-top: 10px; padding-bottom: 10px;">Menu Departamento</caption>
			<tr>
				<td class="op1" id="cadastrar" style="font-size: 150%;"><a
					href="DepartamentoCadastrar.jsp" />Cadastrar</a></td>
			</tr>
			<tr>
				<td class="op1" id="alterar" style="font-size: 150%;"><a
					href="DepartamentoAlterar.jsp" />Alterar</a></td>
			</tr>
			<tr>
				<td class="op1" id="excluir" style="font-size: 150%;"><a
					href="DepartamentoExcluir.jsp" />Excluir</a></td>
			</tr>
			<tr>
				<td class="op1" id="consultar" style="font-size: 150%;"><a
					href="DepartamentoConsultar.jsp" />Consultar</a></td>
			</tr>
			<tr>
		...
		<div style="padding: 15px;">
			<span id="mensagem"
				...
				Cadastrar Departamento</span> <span id="mensagem2"
				style="display: none; width: 550px; font-weight: bold; margin: auto;">
				Alterar Departamento</span> <span id="mensagem3"
				style="display: none; width: 550px; font-weight: bold; margin: auto;">
				Excluir Departamento</span> <span id="mensagem4"
				style="display: none; width: 550px; font-weight: bold; margin: auto;">
				Consultar Departamento</span> <span id="mensagem5"
				style="display: none; width: 550px; font-weight: bold; margin: auto;">
				Relatório dos Departamentos</span> <span id="mensagem6"
				style="display: none; width: 550px; font-weight: bold; margin: auto;">
