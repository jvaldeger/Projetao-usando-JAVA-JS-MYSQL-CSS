...
<body>
	<div class="window" id="janela1" rel="modal">
		...
		<table>
			<caption
				style="font-size: 200%; padding-top: 10px; padding-bottom: 10px;">Menu Funcionário</caption>
			<tr>
				<td class="op1" id="cadastrar" style="font-size: 150%;">
				<a href="FuncionarioCadastrar.jsp" />Cadastrar</a></td>
			</tr>
			<tr>
				<td class="op1" id="alterar" style="font-size: 150%;">
				<a href="FuncionarioAlterar.jsp" />Alterar</a></td>
			</tr>
			<tr>
				<td class="op1" id="excluir" style="font-size: 150%;">
				<a href="FuncionarioExcluir.jsp" />Excluir</a></td>
			</tr>
			<tr>
				<td class="op1" id="consultar" style="font-size: 150%;">
				<a href="FuncionarioConsultar.jsp" />Consultar</a></td>
			</tr>
			<tr>
		...
		<div style="padding: 15px;">
			<span id="mensagem"
				...
				Cadastrar Funcionário</span> <span id="mensagem2"
				style="display: none; width: 550px; font-weight: bold; margin: auto;">
				Alterar Funcionaário</span> <span id="mensagem3"
				style="display: none; width: 550px; font-weight: bold; margin: auto;">
				Excluir Funcionário</span> <span id="mensagem4"
				style="display: none; width: 550px; font-weight: bold; margin: auto;">
				Consultar Funcionário</span> <span id="mensagem5"
				style="display: none; width: 550px; font-weight: bold; margin: auto;">
				Relatório dos Funcionários</span> <span id="mensagem6"
				style="display: none; width: 550px; font-weight: bold; margin: auto;">
