...
<h1 style="text-align: center;">Produto - Alterar</h1>
<table>
<form name="frmProduto" action="ControleProdutoServletAction" method="post">
	...
	<input type="hidden" name="txtValidade" size="10" maxlength="10" value=""></td>
	...
	<input type="hidden" name="selDeposito" maxlength="15" value="0">
	<input type="hidden" name="selProduto" maxlength="15" value="0">
	<td class="op1"><input type="submit" value="Alterar" name="btnOpcao"></td>
