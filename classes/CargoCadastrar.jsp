...
<form name="frmCargo" action="ControleCargoServletAction" method="post">
	...
	<td class="op1" style="font-size:100%;"><input type="text" autofucos name="txtCargo" maxlength="45" value=""></td>
	</tr>
	<tr>
	<th class="op1" style="font-size:100%;">Salario</th>
	<td class="op1" style="font-size:100%;"><input type="text" autofucos name="txtSalario" maxlength="45" value=""></td>
	</tr>
	<tr>
	<th class="op1" style="font-size:100%;">Carga Horaria</th>
	<td class="op1" style="font-size:100%;"><input type="text" autofucos name="txtCargaHoraria" maxlength="45" value=""></td>
	</tr>
	<tr>
	<input type="hidden" name="txtCodCargo" maxlength="45" value="0">
