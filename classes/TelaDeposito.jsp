...
<body>
	<div class="window" id="janela1" rel="modal">
		...
		<table>
			<caption
				style="font-size: 200%; padding-top: 10px; padding-bottom: 10px;">Menu Deposito</caption>
			<tr>
				<td class="op1" id="cadastrar" style="font-size: 150%;"><a
					href="DepositoCadastrar.jsp" />Cadastrar</a></td>
			</tr>
			<tr>
				<td class="op1" id="alterar" style="font-size: 150%;"><a
					href="DepositoAlterar.jsp" />Alterar</a></td>
			</tr>
			<tr>
				<td class="op1" id="excluir" style="font-size: 150%;"><a
					href="DepositoExcluir.jsp" />Excluir</a></td>
			</tr>
			<tr>
				<td class="op1" id="consultar" style="font-size: 150%;"><a
					href="DepositoConsultar.jsp" />Consultar</a></td>
			</tr>
			<tr>
		...
		<div style="padding: 15px;">
			<span id="mensagem"
				...
				Criar um novo Deposito</span> <span id="mensagem2"
				style="display: none; width: 550px; font-weight: bold; margin: auto;">
				Alterar um Deposito</span> <span id="mensagem3"
				style="display: none; width: 550px; font-weight: bold; margin: auto;">
				Excluir um Deposito</span> <span id="mensagem4"
				style="display: none; width: 550px; font-weight: bold; margin: auto;">
				Consultar um Deposito</span> <span id="mensagem5"
				style="display: none; width: 550px; font-weight: bold; margin: auto;">
				Relatório dos Depositos</span> <span id="mensagem6"
				style="display: none; width: 550px; font-weight: bold; margin: auto;">
