...
public class FuncionarioHibernate {
	...
	@ManyToOne
	@JoinColumn(name = "cecodCargo")
	private CargoHibernate cargo;
	
	@ManyToOne
	@JoinColumn(name = "cecodDepartamento")
	...
	private int zona;
	private int secao;
	private String comprovantereservista;
	private String pis;
	...
	public String getComprovantereservista() {
		return comprovantereservista;
	}




	public void setComprovantereservista(String comprovantereservista) {
		this.comprovantereservista = comprovantereservista;
	}
